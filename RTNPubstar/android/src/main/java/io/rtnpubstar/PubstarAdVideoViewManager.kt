...
import com.facebook.react.viewmanagers.PubstarAdVideoViewManagerDelegate
import com.facebook.react.viewmanagers.PubstarAdVideoViewManagerInterface
...
@ReactModule(name = PubstarAdVideoViewManager.NAME)
class PubstarAdVideoViewManager() : SimpleViewManager<FrameLayout>(),
    PubstarAdVideoViewManagerInterface<FrameLayout> {
    private val pubstarHandle = PubstarAdHandler()

    companion object {
        const val NAME = "PubstarAdVideoView"
    }

    private val delegate: PubstarAdVideoViewManagerDelegate<FrameLayout, PubstarAdVideoViewManager> =
        PubstarAdVideoViewManagerDelegate(this)

    override fun getDelegate(): PubstarAdVideoViewManagerDelegate<FrameLayout, PubstarAdVideoViewManager> =
        delegate
